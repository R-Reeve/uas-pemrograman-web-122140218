...
export default function Navbar() {
  ...
  return (
    <div className="w-full">
      {/* Top Header Bar */}
      <div className="bg-blue-800 text-white py-1 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="text-sm">
            {loggedIn ? (
              ...
              <span>Silakan <Link to="/login" className="underline">login</Link> atau <Link to="/register" className="underline">register</Link></span>
            )}
          </div>
        </div>
      </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <Link to="/home" className="flex items-center space-x-2">
              <div className="bg-white p-1 rounded-full">
                <span className="text-2xl text-blue-600">FF</span>
              </div>
              <h1 className="text-2xl font-bold text-white">Iki Epep</h1>
            </Link>
            ...
            <div className="hidden md:flex space-x-6 text-white items-center">
              ...
              {loggedIn ? (
                ...
                <Link
                  to="/login"
                  className="bg-white text-blue-700 px-4 py-1 rounded hover:bg-blue-100 transition-colors"
                >
                  Login
                </Link>
              )}
            ...
            <div className="md:hidden mt-2 py-2 border-t border-blue-500">
              <div className="flex flex-col space-y-2 text-white">
                ...
                {loggedIn && (
                  <button
                    onClick={handleLogout}
                    className="bg-red-500 text-white px-4 py-1 rounded hover:bg-red-600 transition-colors text-left"
                  >
                    Logout
                  </button>
                )}
